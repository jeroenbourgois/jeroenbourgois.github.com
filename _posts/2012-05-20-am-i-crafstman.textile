...
I am a craftsman, and a damned good one. So are all of us geeks and programmers. We create complex things, by hand and a lot of times by heart. We even take it one step further sometimes, working without a manual, with technologies that change faster than McDonald's brings out a new burger. So we should start being proud of our crafstmanship! But we aren't proud, we just build it and move on to the next one. Cause that's how we roll.
